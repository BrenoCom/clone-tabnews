...
describe("POST /api/v1/migrations", () => {
  describe("Anonymous user", () => {
    test("Apply all migrations", async () => {
      // Get information about migrations before applying
      const migrationsResponse = await fetch(baseUrl + "/api/v1/migrations");
    ...
    test("Try to apply all migrations for Empty", async () => {
